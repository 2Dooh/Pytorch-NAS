...
import random
from computational_graphs.custom_models.mlp import MultiLayerPerceptron
class TSSSurrogateModel(TSSBench201):
    ...
    def __init__(self, 
        ...
        super().__init__(n_obj=2,
                         ...
                         **kwargs) 
        self.device = torch.device('cuda:0' if cuda else 'cpu')
        self.ntk_lr_metrics = GradientFreeMetric(input_size, dataset, 'best', seed, num_workers)
