...
#         self.ntk_lr_metrics = GradientFreeEvaluator(input_size, dataset, n_repeats, 'best', seed, num_workers)
...
#                          **kwargs) 
#         self.ntk_lr_metrics = GradientFreeEvaluator(input_size, dataset, n_repeats, cuda, seed, num_workers)
#         self.device = torch.device('cuda:0' if cuda else 'cpu')
#         self.global_ntks = []
#         self.global_lrs = []
#         self.global_indices = []
