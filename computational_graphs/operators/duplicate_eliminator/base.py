...
from utils.evo_alg.dist import cdist
...
class DefaultDuplicateEliminator(DuplicateEliminator):
...
class ElementwiseDuplicateEliminator(DefaultDuplicateEliminator):
...
def to_hash(x):
    try:
        ...
        try:
            ...
            raise Exception("Hash could not be calculated. Please use another duplicate Eliminator.")

    return h


class HashDuplicateEliminator(DuplicateEliminator):
...
class NoDuplicateEliminator(DuplicateEliminator):
